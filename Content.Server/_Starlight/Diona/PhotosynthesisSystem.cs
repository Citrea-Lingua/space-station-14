...
using Content.Shared._Starlight.Diona;
using Content.Server._Starlight.Shadekin;

namespace Content.Server._Starlight;

public sealed partial class PhotosynthesisSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<PhotosynthesisComponent, RefreshMovementSpeedModifiersEvent>(OnRefreshMovementSpeedModifiers);
    }

    public void UpdateAlert(EntityUid uid, PhotosynthesisComponent component, short state)
    {
    ...
    private void OnRefreshMovementSpeedModifiers(EntityUid uid, PhotosynthesisComponent component, RefreshMovementSpeedModifiersEvent args)
    {
    ...
    private void CheckThresholds(EntityUid uid, PhotosynthesisComponent component, float lightExposure)
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<PhotosynthesisComponent>();
