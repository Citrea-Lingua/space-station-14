...
namespace Content.Server._Starlight.Scent
{
    public sealed class ScentSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<ScentComponent, BeingGibbedEvent>(OnBeingGibbed);
            SubscribeLocalEvent<ScentComponent, MeleeHitEvent>(OnMeleeHit);
            SubscribeLocalEvent<ScentComponent, GotRehydratedEvent>(OnRehydrated);
            SubscribeLocalEvent<CleansForensicsComponent, AfterInteractEvent>(OnAfterInteract, after: new[] { typeof(AbsorbentSystem) });
            SubscribeLocalEvent<ScentComponent, CleanForensicsDoAfterEvent>(OnCleanForensicsDoAfter);
